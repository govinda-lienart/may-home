...
const translations = {
  en: {
    ...
    'about.label': 'Welcome to May Home',
    'about.title': 'Not a hotel.<br><em>A home.</em>',
    'about.p1': 'Halfway between Đà Nẵng and Hội An. Eight minutes walk to An Bàng Beach. Fifteen minutes by motorbike to everywhere you want to be.',
    'about.p2': 'Come back each evening to plants, yellow light, and clean quiet rooms. Two local hosts who know every hidden beach, every right bowl of soup — always there when you need them, never in your way.',
    'about.p3': 'We\'re for slow travellers. People who want to live somewhere, not just pass through.',
    'about.tagline': 'Minimum one month. Worth every day.',
    ...
    'room1.eyebrow': 'Ground floor — 01', 'room1.desc': 'Exposed brick, vintage wood, warm amber light. Grounding, quiet, deeply restful.',
    'room2.eyebrow': '1st floor — 02', 'room2.desc': 'Yellow walls, coconut palms at the window. Wake up feeling like sunshine.',
    'room3.eyebrow': '1st floor — 03', 'room3.desc': 'Wrapped in tropical greens, softly lit. Lush, intimate, and always cool.',
    'room4.eyebrow': '2nd floor — 04', 'room4.desc': 'Palm fronds frame every window. Airy, light-filled, with a gentle cross breeze.',
    'room5.eyebrow': '2nd floor — 05', 'room5.desc': 'Quiet, compact, full of charm. A perfect hideaway for solo travellers or couples.',
    ...
    'tag.yellow': 'Yellow Walls', 'tag.palm': 'Palm View', 'tag.bright': 'Bright &amp; Airy',
    'tag.tropical': 'Tropical Garden', 'tag.lush': 'Lush &amp; Green', 'tag.intimate': 'Intimate',
    'tag.breeze': 'Cross Breeze', 'tag.floor2': '2nd Floor',
    'tag.compact': 'Compact', 'tag.quiet': 'Quiet', 'tag.sharedbath': 'Shared Bathroom', 'tag.value': 'Best Value',
  ...
  vi: {
    ...
    'hero.desc': 'Nơi những buổi sáng bình yên, khu vườn nhiệt đới<br class="br-desktop"> và sự ấm áp chân thành hòa quyện.',
    'hero.cta1': 'Khám phá phòng', 'hero.cta2': 'Liên hệ',
    'about.label': 'Chào mừng đến May Home',
    'about.title': 'Không phải khách sạn.<br><em>Là ngôi nhà.</em>',
    'about.p1': 'Nằm giữa Đà Nẵng và Hội An. Tám phút đi bộ đến bãi biển An Bàng. Mười lăm phút xe máy đến mọi nơi bạn muốn.',
    'about.p2': 'Mỗi buổi tối trở về với cây xanh, ánh đèn vàng và những căn phòng sạch sẽ, yên tĩnh. Hai người chủ nhà địa phương biết từng bãi biển ẩn, từng tô súp đúng điệu — luôn ở đây khi bạn cần, không bao giờ làm phiền bạn.',
    'about.p3': 'Chúng tôi dành cho những người lữ hành chậm rãi. Những người muốn sống ở một nơi, không chỉ đi qua.',
    'about.tagline': 'Tối thiểu một tháng. Xứng đáng từng ngày.',
    'stay.text': '<strong>Chúng tôi yêu những kỳ lưu trú dài.</strong> May Home cho thuê theo tháng — tối thiểu 1 tháng. Cách tuyệt vời để chậm lại, ổn định và thực sự sống như người địa phương tại một trong những góc kỳ diệu nhất của Việt Nam. <em>Liên hệ với chúng tôi và hãy cùng thực hiện điều đó.</em>',
    'stay.btn': 'Hỏi ngay',
    ...
    'room1.eyebrow': 'Tầng trệt — 01', 'room1.desc': 'Gạch lộ thiên, gỗ cổ điển, ánh đèn hổ phách ấm áp. Vững chắc, yên tĩnh, thư giãn sâu sắc.',
    'room2.eyebrow': 'Tầng 1 — 02', 'room2.desc': 'Tường vàng, hàng dừa ngoài cửa sổ. Thức dậy với cảm giác như ánh nắng.',
    ...
    'tag.yellow': 'Tường Vàng', 'tag.palm': 'View Dừa', 'tag.bright': 'Sáng &amp; Thoáng',
    'tag.tropical': 'Vườn Nhiệt Đới', 'tag.lush': 'Xanh Mướt', 'tag.intimate': 'Ấm Cúng',
    'tag.breeze': 'Gió Mát', 'tag.floor2': 'Tầng 2',
    'tag.compact': 'Nhỏ Gọn', 'tag.quiet': 'Yên Tĩnh', 'tag.sharedbath': 'Phòng Tắm Chung', 'tag.value': 'Giá Tốt Nhất',
...
function setLang(lang) {
  ...
  document.querySelectorAll('.room-block[data-price-usd]').forEach(block => {
...
/* ── GALLERIES ──────────────────────────────────── */
const galleries = [
  { name: 'Rooted Calm',   imgs: ['media/pictures_space/room_3/IMG_5095.jpg','media/pictures_space/room_3/IMG_5085.jpg','media/pictures_space/room_3/IMG_5088.jpg','media/pictures_space/room_1/IMG_5074.jpg'] },
  { name: 'Morning Glow',  imgs: ['media/pictures_space/room_2/IMG_0946.jpg','media/pictures_space/room_5/IMG_5290.jpg','media/pictures_space/room_5/IMG_5380.jpg','media/pictures_space/room_5/IMG_5355.jpg'] },
