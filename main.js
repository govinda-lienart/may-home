...
const translations = {
  en: {
    ...
    'about.p1': 'Perfectly placed between Đà Nẵng and Hội An. Two cities, two moods. Beach at your doorstep.',
    'about.p2': 'Inside: plants, yellow light, clean rooms that breathe. Two local hosts, always close enough to help, never in your way.',
    'about.p3': 'For those who want to live a place, not just visit it.',
  ...
  vi: {
    ...
    'about.p1': 'Nằm giữa Đà Nẵng và Hội An. Hai thành phố, hai nhịp sống. Bãi biển ngay trước cửa.',
    'about.p2': 'Bên trong: cây xanh, ánh đèn vàng, những căn phòng sạch sẽ và thoáng. Hai người chủ nhà luôn đủ gần để giúp đỡ, không bao giờ làm phiền bạn.',
    'about.p3': 'Dành cho những ai muốn sống trong một nơi, không chỉ ghé qua.',
